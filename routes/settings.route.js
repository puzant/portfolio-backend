...
const settingsController = new SettingsController(settingsService, backupService)
...
router.post('/backup', authMiddleware, restrictTo("admin"), settingsController.createBackup)
